            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <div>{{ scope.row.EX_TIME != 'NULL'? scope.row.EX_TIME : '无' }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
              ...
              <el-table-column
                ...
                prop="MEAS_PINCH_WID">
                <template slot-scope="scope">
                  <div>{{ Number(scope.row.MEAS_PINCH_WID).toFixed(3) }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
                ...
                prop="MEAS_CS_WID">
                <template slot-scope="scope">
                  <div>{{ Number(scope.row.MEAS_CS_WID).toFixed(3) }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
              ...
              <el-table-column
                align="center"
                label="重合度调整"
                prop="MEAS_COINCIDE_THK">
                <template slot-scope="scope">
                  <div>{{ scope.row.MEAS_COINCIDE_THK != 0 ? Number(scope.row.MEAS_COINCIDE_THK).toFixed(3) : 0 }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
                label="碎边剪水平间隙"
                prop="MEAS_SCRAP_GAP_THK">
                <template slot-scope="scope">
                  <div>{{ scope.row.MEAS_SCRAP_GAP_THK != 0 ? Number(scope.row.MEAS_SCRAP_GAP_THK).toFixed(1) : 0 }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
          ...
          <el-row
            ...
            <el-table
              ...
              <el-table-column
                ...
                prop="SET_PLATELEN">
                <template slot-scope="scope">
                  <div>{{ scope.row.SET_PLATELEN }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
                ...
                prop="SET_PLATEWID">
                <template slot-scope="scope">
                  <div>{{ scope.row.SET_PLATEWID }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
                ...
                prop="SET_PLATETHK">
                <template slot-scope="scope">
                  <div>{{ scope.row.SET_PLATETHK }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
              ...
              <el-table-column
                ...
                prop="SET_THK_GAP">
                <template slot-scope="scope">
                  <div>{{ Number(scope.row.SET_THK_GAP).toFixed(3) }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
                ...
                prop="SET_THK_COIN">
                <template slot-scope="scope">
                  <div>{{ scope.row.SET_THK_COIN }}</div>
                </template>
              </el-table-column>
              <el-table-column
                align="center"
                label="碎边剪剪刃间隙"
                prop="SET_THK_GAP_SCRAP">
                <template slot-scope="scope">
                  <div>{{ Number(scope.row.SET_THK_GAP_SCRAP).toFixed(3) }}</div>
                </template>
              </el-table-column>
            </el-table>
          </el-row>
